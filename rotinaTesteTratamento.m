...
%   na outra o valor minimo que o empregador deseja que o candidato tenha
%   naquele criterio.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Teste: Assumindo que todos os criterios sao desejaveis e inserindo % 
% valores de teste                                                   %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

listaIDs = {};
listaIDs = {'590a6667de3d881e25bd639b','590a66ccde3d881e25bd651f','590a66e1de3d881e25bd658e','590a671cde3d881e25bd66ba','590a66a1de3d881e25bd646c'};

criterios = cell(25,2);

criterios{1,1} = 'ultima_atualizacao';
criterios{2,1} = 'desempregado';
criterios{3,1} = 'bairro';
criterios{4,1} = 'cidade';
criterios{5,1} = 'estado';
criterios{6,1} = 'deficiencia';
criterios{7,1} = 'sexo';
criterios{8,1} = 'idade';
criterios{9,1} = 'disponibilidade_viagem';
criterios{10,1} = 'estado_civil';
criterios{11,1} = 'cnh';
criterios{12,1} = 'idiomas_nivel';
criterios{13,1} = 'idiomas_lingua';
criterios{14,1} = 'formacao_conclusao';
criterios{15,1} = 'formacao_curso';
criterios{16,1} = 'formacao_grau';
criterios{17,1} = 'formacao_inicio';
criterios{18,1} = 'experiencia_cargo';
criterios{19,1} = 'experiencia_duracao';
criterios{20,1} = 'experiencia_nivel';
criterios{21,1} = 'competencias';
criterios{22,1} = 'salario';
criterios{23,1} = 'objetivos_areas';
criterios{24,1} = 'objetivos_cargo';
criterios{25,1} = 'objetivos_niveis';

criterios{1,2} = 'Tue May 02 21:00:00 BRT 2017';
criterios{2,2} = false;
criterios{3,2} = 'Icarai';
criterios{4,2} = 'Niteroi';
criterios{5,2} = 'RJ';
criterios{6,2} = false;
criterios{7,2} = 'F';
criterios{8,2} = [35 40];
criterios{9,2} = true;
criterios{10,2} = 'Solteiro';
criterios{11,2} = 'B';
criterios{12,2} = {'Avancado','Nativo','Nativo'};
criterios{13,2} = {'Ingles','Portugues','Espanhol'};
criterios{14,2} = 'o momento';
criterios{15,2} = {'Engenharia ambiental'};
criterios{16,2} = {'Ensino Superior'};
criterios{17,2} = 'Wed Dec 31 22:00:00 BRST 2014';
criterios{18,2} = {'Assistente Administrativo'};
criterios{19,2} = 15;
criterios{20,2} = 'Assistente';
criterios{21,2} = {'Microsoft Excel','Microsoft Outlook','Microsoft PowerPoint','Microsoft Word','Lotus Notes'};
criterios{22,2} = 4500;
criterios{23,2} = {'Administracao'};
criterios{24,2} = {'Secretariado'};
criterios{25,2} = {'Assistente'};

Ncrit = length(criterios); % Numero de criterios nao obrigatorios
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Parte 1: Pegando os candidatos com os IDs passados como parametro %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% dados = 100.*rand(NId,Ncrit);

fprintf('O Ranking dos candidatos por ID é:\n');
listaDeCandidatos = tomadaDeDecisao(dados,w,listaIDs);

for i=1:NId
   fprintf('%d - %s\n',i,listaDeCandidatos{i}); 
end